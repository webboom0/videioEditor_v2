...
function VideoEditor() {
  ...
  const [layers, setLayers] = useState([
    ...
    },
    {
      ...
      scale: 1, // 시작 scale (1 = 원본 크기)
      animation: [
        { time: 10, x: 0, y: 0, scale: 1 }, // 시작 (원본 크기)
        { time: 12, x: 0, y: 0, scale: 1.2 }, // 2초 시점 (1.2배)
        { time: 15, x: 0, y: 0, scale: 1.5 }, // 5초 시점 (1.5배)
        { time: 20, x: 0, y: 0, scale: 1 }, // 끝 (원본 크기)
      ],
    },
    {
      type: "image",
      ...
      scale: 1, // 시작 scale (1 = 원본 크기)
      animation: [
        { time: 20, x: 0, y: 0, scale: 1 }, // 시작 (원본 크기)
        { time: 22, x: 20, y: 0, scale: 1.2 }, // 2초 시점 (1.2배)
        { time: 25, x: 0, y: 0, scale: 1.5 }, // 5초 시점 (1.5배)
        { time: 30, x: 0, y: 0, scale: 1 }, // 끝 (원본 크기)
      ],
    },
    {
      type: "image",
      ...
      scale: 1, // 시작 scale (1 = 원본 크기)
      animation: [
        { time: 40, x: 0, y: 0, scale: 1 }, // 시작 (원본 크기)
        { time: 42, x: 0, y: 0, scale: 1.2 }, // 2초 시점 (1.2배)
        { time: 45, x: 0, y: 0, scale: 1.5 }, // 5초 시점 (1.5배)
        { time: 50, x: 0, y: 0, scale: 1 }, // 끝 (원본 크기)
      ],
    },
    {
      type: "image",
      ...
      scale: 1, // 시작 scale (1 = 원본 크기)
      animation: [
        { time: 50, x: 0, y: 0, scale: 1 }, // 시작 (원본 크기)
        { time: 52, x: 0, y: 0, scale: 1.2 }, // 2초 시점 (1.2배)
        { time: 55, x: 0, y: 0, scale: 1.5 }, // 5초 시점 (1.5배)
        { time: 50, x: 0, y: 0, scale: 1 }, // 끝 (원본 크기)
      ],
    },
    {
      ...
      scale: 1, // 시작 scale (1 = 원본 크기)
      animation: [
        { time: 60, x: 0, y: 0, scale: 1 }, // 시작 (원본 크기)
        { time: 62, x: 0, y: 0, scale: 1.2 }, // 2초 시점 (1.2배)
        { time: 65, x: 0, y: 0, scale: 1.5 }, // 5초 시점 (1.5배)
        { time: 60, x: 0, y: 0, scale: 1 }, // 끝 (원본 크기)
      ],
    },
    // {
    //   type: "video",
